...
gcc -O3 -march=native -flto -s -municode -mwindows -Wall -Wextra -fstack-protector-strong -D_FORTIFY_SOURCE=2 -o HydraRemuxer.exe remux.c resource.o -lcomctl32 -lcomdlg32 -lshell32 -lshlwapi -lole32 -luuid
if errorlevel 1 exit /b 1
echo.
